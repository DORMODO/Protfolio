    ...
    <section id="about" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div aria-label="About Me" className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              functional web applications. I love turning ideas into reality and
              enjoy the challenge of solving complex problems through code.
            </p>
          ...
          <div aria-label="Skills" className="grid grid-cols-1 gap-6">
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Creating responsive web applications with modern
                    technologies.
                  </p>
                </div>
              </div>
